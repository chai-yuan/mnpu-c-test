/*
 * ESC Environmental Sound CNN inference example (runtime/memory-mapped input).
 *
...
static const char *TEST_LABEL_NAMES[] = {
    "dog", "rain", "crying_baby", "clock_tick", "crackling_fire"
};
...
int main(void) {
    ...
    printf("TinyML ESC Environmental Sound CNN (INT8) – memory-mapped input\n");
    ...
    printf("  Input base address: 0x%x\n\n", (unsigned)INPUT_BASE_ADDR);
